...
public class TodoControllerTests {
    ...
    public void testGetTodoById() throws Exception {
        TodoResponseDto todo = new TodoResponseDto(1L, "Test Todo", "Description",
                false);
    ...
    public void testGetAllTodos() throws Exception {
        ...
        given(todoService.findAll()).willReturn(Collections.singletonList(
    ...
    public void testCreateTodo() throws Exception {
        TodoResponseDto todo = new TodoResponseDto(1L, "New Todo", "Description"
                , false);
        ...
        mockMvc.perform(
                        post("/api/todos/v2")
                                ...
                                .content("{\"title\": \"New Todo\", \"description\":"
                                        + " \"Description\"}"))
    ...
    public void testUpdateTodo() throws Exception {
        TodoResponseDto existingTodo =
                new TodoResponseDto(1L, "Existing Todo", "Description",
                        false);
